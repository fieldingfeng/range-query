...
public interface RangeContainerFactory {
	 ...
	 * expected to be 32k items or less. The position in the “data” array
	 * represents the “id” for that instance in question. For the
	 * “PayrollResult” example before, the “id” might be the worker’s employee
